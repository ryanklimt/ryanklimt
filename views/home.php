<section id="content">
	...
	<!--HEADLINE & SLIDESHOW-->	
	<header id="headline">
		<h2>The art &amp; science of web design</h2>
		<p>I make beautiful websites that are both simple yet sophisticated. It’s a fine balance between art and science.</p>
	</header>
	
	<div id="slideshow">
		<div id="passion" class="slide" >
			<header>
				<h2>Passion</h2>
...
<div id="social">
	...
	<div class="intro">
		<h3>Need help building a website?</h3>
		<p>Give me a call at 847 912-2543</p>
		<p>Email me at  <a href="mailto:ryanklimt@gmail.com">ryanklimt@gmail.com</a></p>
	</div>	
	<div class="networks">
		<ul>
			<li class="linkedin">Connect with me on <a href="http://linkedin.com/in/ryanklimt">LinkedIn</a></li>
			<li class="youtube">Watch me on <a href="http://youtube.com/mrgamingcollege">YouTube</a></li>
		</ul>
	</div>
</div>