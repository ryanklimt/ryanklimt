		...
		<div class="app-details">
			...
			<div class="app-points">
				...
				<div class="app-stats">
					<h2>Other Facts</h2>	
					<ul>
						<li>Quick to learn game</li>
						<li>Over 2,000 plays within first day of release</li>
						<li>New levels added regularly</li>
					</ul>
				</div>
			</div>
		</div>
	...
	<div class="app">
		...
		<div class="app-details">
			...
			<div class="app-points">
				...
				<h2>Features</h2>	
					<ul>
						<li>Content management system for artwork</li>
						<li>Multiple galleries</li>
						<li>Paralax scrolling</li>
						<li>Slideshows for an interactive feel</li>
				...
				<div class="app-stats">
					<h2>Other Facts</h2>	
					<ul>
						<li>Layout and overall theme by Matthew Morse</li>
						<li>Created using custom made PHP</li>
					</ul>
				</div>
			</div>
		</div>
