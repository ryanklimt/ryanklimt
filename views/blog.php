<div id="archive">
	...
	<article class="post random-thoughts">
		...
		<header>
			...
			<p class="post-meta"><span>Posted on</span> 22 December 2013 by George Hammerton</p>
			<a href="#" class="comment-count" title="Comment on “I wish I’d thought of that”, 2013">0 <span>Comments</span></a>
		</header>

		<p>For the last couple of years we’ve each picked a favourite app from the previous year which we thought was so great we found ourselves saying, “I wish I’d thought of that”. Here are our personal favourites of 2013.</p>
		<p><strong>George:</strong> &nbsp;<a title="Seene for iPhone" href="#" target="_blank">Seene</a>&nbsp;— <em>“Fantastic idea, well executed. I’m still not sure if I actually need to use it but I’m impressed every time I do.”</em></p>
		<p><strong>Liam: </strong><a title="Letterpress for iOS" href="#" target="_blank">Letterpress</a>&nbsp;— <em>“Simple, nicely done and challenging.”</em></p>
		<p><strong>Justin: </strong><a title="Tweetbot 3 for iPhone" href="#" target="_blank">Tweetbot 3</a> — <em>“Best twitter client ever.”</em></p>
		<p><strong>Ben:</strong>&nbsp;<a title="Whale Trail for iOS" href="#" target="_blank">Whale Trail</a> — <em>“Great game, great soundtrack.”</em></p>
		<p>If you have a particular favourite from this year we’d love to hear about them in the comments. <a href="#" class="read_more" rel="nofollow"> More…</a></p>
	</article>
	<article class="post life-at-create-dm">
		...
		<header>
			...
			<p class="post-meta"><span>Posted on</span> 20 December 2013 by George Hammerton</p>
	...
	<article class="post industry-insights">
		...
		<header>
			...
			<p class="post-meta"><span>Posted on</span> 20 December 2013 by Justin Erswell</p>
			<a href="#" class="comment-count" title="Comment on OS X Mavericks">1 <span>Comment</span></a>
		</header>
		
		<p><img class="alignnone size-full wp-image-2192" alt="Mavericks Wallpaper" src='images/Mavericks-Wallpaper.png'></p>
	...
	<article class="post new-releases">
		...
		<header>
			...
			<p class="post-meta"><span>Posted on</span> 19 November 2013 by Liam Moody</p>
			<a href="#" class="comment-count" title="Comment on Drive 1.1.2 adds German &amp; Dutch language support">1 <span>Comment</span></a>
		</header>
		
		<p>We’ve just released an update to <a href="#">Drive</a> which adds native language support for our German and Dutch users. The update also features a tweaked app icon for those users running iOS 7 to make Drive feel a bit more at home on the new flatter, more colourful interface.</p>
		<p><strong>Drive 1.1.2:</strong></p>
		<p>★ Adds German language support<br>
		★ Adds Dutch language support<br>
		...
		<header>
			...
			<p class="post-meta"><span>Posted on</span> 1 November 2013 by George Hammerton</p>
			<a href="#" class="comment-count" title="Comment on New Marketing Site for PASS">1 <span>Comment</span></a>
		</header>
